        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-[#E0EDF6] p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                    className="font-HSBold leading-6 text-gray-900 text-center pb-4"
                  >
                    Email already exist!
                    <br />
                    Please login with this email first
                  </Dialog.Title>
                  <div className="mt-2 ">
                    <Image
                      className="mx-auto"
